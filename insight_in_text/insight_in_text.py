...
single_word_tokenized_sentence = word_tokenized_text[12]
...
for wts in word_tokenized_text:
  # part-of-speech tag each sentence and append to list of pos-tagged sentences here
  pos_tagged_text.append(pos_tag(wts))

# store and print any part-of-speech tagged sentence here
single_pos_sentence = pos_tagged_text[36]
