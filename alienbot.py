...
class AlienBot:
  ...
  # Define .greet() below:
  def greet(self):
    self.name = input("Greetings human. How should I address you? ")
  ...
  def describe_planet_intent(self):
    responses = ("My planet is a utopia of diverse oraganisms and species. ", "I am from Opidipus, the capital of the Wayward Galaxies. ")
