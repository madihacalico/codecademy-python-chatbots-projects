...
# get sentences of multiple presidents
latest_prez_sentences = get_presidents_sentences(["trump","obama","george-w-bush","clinton"])

latest_prez_embeddings = gensim.models.Word2Vec(latest_prez_sentences, size=96, window=5, min_count=1, workers=2, sg=1)

latest_similar_to_freedom = latest_prez_embeddings.most_similar("freedom", topn=20)
print(latest_similar_to_freedom)
